      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-500/10 via-[#09090b] to-[#09090b] items-center justify-center p-12">
        <div className="max-w-md">
          ...
          <h1 className="text-4xl font-bold mb-4 leading-tight">
            ...
            <br />
            <span className="text-orange-500">in under a minute</span>
          </h1>
          <p className="text-zinc-400 text-lg leading-relaxed">
            Connect your Cloudflare account, install a connector, and your local service is live.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-zinc-500 mb-8">
            Get started with Porter for free.
          </p>
